...
/*
 * To create an object of MOEA/D-DE-ACA algorithm (alias: MOEAD2), the original
 * implementation of MOEA/D (alias: MOEAD) in MOEA FRAMEWORK 2.12 was used.
 * changes:
 * - Line 286        : The attribute used to communicate the weight vectors to this class
 * - Lines 415 to 423: Used the initialization based on Covering Arrays or Augmented
 *                     Covering Arrays
 */
 ...
 * </ol>
 */
public class MOEAD2 extends AbstractAlgorithm {
	...
	public ArrayList<double[]> weightRows;
	 ...
	 */
	public MOEAD2(Problem problem, int neighborhoodSize,
	...
	private void initializePopulation(int populationSize) {
		...
		for (double[] weight : weightRows) {
			population.add(new Individual(weight));
		}
		TestAll.PrintWeights(weightRows, "MOEA-D-DE-ACAs", this.getProblem().getName(),
